...
namespace kernel { 
	namespace shaders {
		extern const unsigned int d_gemm_spv[1294];
		extern const unsigned int gradient_spv[461];
		...
		extern const unsigned int gemm_spv[1073];
		...
		extern const unsigned int vol2col_spv[2168];
