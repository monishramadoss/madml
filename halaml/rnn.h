	...
	namespace layers
	{
		namespace rnn
		{
			...
			public:
				...
				void hook(std::shared_ptr<tensor>& x, std::shared_ptr<tensor>& h, std::shared_ptr<tensor>& y,
			...
			public:
				...
				void hook(std::shared_ptr<tensor>& x, std::shared_ptr<tensor>& h, std::shared_ptr<tensor>& c,
